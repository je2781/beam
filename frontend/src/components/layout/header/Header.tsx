...
export default function Header({
  ...
  return (
    <nav className="lg:pl-[18.5%] xl:pl-[21%] md:pl-[4%] pl-[6%] lg:pr-0 xl:pr-[1%] md:pr-[4%] pr-[6%] lg:py-[1.6%] md:py-[3%] py-[6%] flex flex-row items-start justify-between w-full fixed h-[100px] top-0 left-0 z-5 bg-white border border-primary-200 border-t-0 border-l-0 border-r-0">
